...
my $pibase_specs = {
   ...
   user => 'pibaseuser' ,
   pass => 'pibasepassword',
   root => '/groups/karpova/home/davisf/work/pibase/pibase200708',
} ;
...
## from Janin 1998 JMB captures H20-mediated
   ...
   $pibase_specs->{external_data}->{scop} = {
      ...
      files => {
         cla => 'dir.cla.scop.txt_1.73',
         des => 'dir.des.scop.txt_1.73',
         hie => 'dir.hie.scop.txt_1.73',
      },
      urls => {
       'http://scop.mrc-lmb.cam.ac.uk/scop/parse/dir.hie.scop.txt_1.73' => 0,
       'http://scop.mrc-lmb.cam.ac.uk/scop/parse/dir.cla.scop.txt_1.73' => 0,
       'http://scop.mrc-lmb.cam.ac.uk/scop/parse/dir.des.scop.txt_1.73' => 0,
      }
   } ;
   ...
   $pibase_specs->{external_data}->{astral} = {
      ver => '1.73',
      urls => {
         'http://astral.berkeley.edu/scopseq-1.73.tgz' => 0,
         'http://astral.berkeley.edu/raf/astral-rapid-access-1.73.raf' => 0,
      },
      postcommands => {
         'http://astral.berkeley.edu/scopseq-1.73.tgz' =>
            "tar xvfz scopseq-1.73.tgz"
      },
   } ;
   ...
   $pibase_specs->{external_data}->{cath} = {
      ...
      files => {
         CathNames => 'CathNames.v3.1.0',
         CathDomainList => 'CathDomainList.v3.1.0',
         CathDomainDescription => 'CathDomainDescriptionFile.v3.1.0',
      },
      processed_files => {
         cath_names => 0,
      ...
      urls => {
'ftp://ftp.biochem.ucl.ac.uk/pub/cathdata/v3.1.0/CathChainList.v3.1.0' => 0,
'ftp://ftp.biochem.ucl.ac.uk/pub/cathdata/v3.1.0/CathDomainList.v3.1.0' => 0,
'ftp://ftp.biochem.ucl.ac.uk/pub/cathdata/v3.1.0/CathNames.v3.1.0' => 0,
'ftp://ftp.biochem.ucl.ac.uk/pub/cathdata/v3.1.0/CathDomall.v3.1.0' => 0,
'ftp://ftp.biochem.ucl.ac.uk/pub/cathdata/v3.1.0/CathDomainDescriptionFile.v3.1.0' => 0,
      }
   } ;
...
#fpd080630_0029  weird bug - sometimes uname -p returns nothing??
   ...
   $binaries->{'rigor'} = "$rootdir/aux/".
      "rigor/rigor.$mach" ;

   $binaries->{'subset_extractor'} = "$rootdir/aux/".
   ...
   $binaries->{'altloc_check'} = "$rootdir/aux/".
   ...
   $binaries->{'altloc_filter'} = "$rootdir/aux/".
   ...
   $binaries->{'inscode_check'} = "$rootdir/aux/".
   ...
   $binaries->{'ccp4sc'} = "$rootdir/aux/ccp4sc/ccp4sc.$mach" ;
   if (! -e $binaries->{'ccp4sc'}) {
      $binaries->{'ccp4sc'} = "ERROR" ;
   } else {
      $binaries->{'ccp4sc'} .= " -nosummary -nohtml -n SCRADII $rootdir/aux/ccp4sc/sc_radii.lib XYZIN" ;
   }

   $binaries->{'princip'} = "$rootdir/aux/princip/princip.$mach" ;
   if (! -e $binaries->{'princip'}) {
      $binaries->{'princip'} = "ERROR" ;
   }

   $binaries->{'kdcontacts'} = "$rootdir/aux/".
